...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 26, fontWeight: '600', color: UI_COLORS.text, letterSpacing: -0.5, marginBottom: 4 },
  ...
  btnGoogle: { width: '100%', height: 44, borderRadius: 12, backgroundColor: UI_COLORS.card, borderWidth: 0.5, borderColor: UI_COLORS.border, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  btnGoogleTxt: { fontSize: 13, color: UI_COLORS.text2 },
